...
- Baixe a última versão do módulo **[nesse link](https://github.com/pagseguro/magento/raw/master/UOL_PagSeguro-3.15.0.tgz)** ou então baixe o repositório como arquivo zip através do botão do GitHub;
